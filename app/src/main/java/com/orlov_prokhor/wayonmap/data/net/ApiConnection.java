...
/**
 * Api Connection class used to retrieve data from the cloud. Implements {@link
 * java.util.concurrent.Callable} so when executed asynchronously can return a value.
 */
class ApiConnection implements Callable<String> {
  ...
  /**
   * Do a request to an api synchronously. It should not be executed in the main thread of the
   * application.
   *
